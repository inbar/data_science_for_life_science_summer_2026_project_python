...
def get_trained_model_file_path(test_split_size: int = config.DEFAULE_TEST_SPLIT_SIZE,
                                seed: int = config.DEFAULT_SEED,
                                subsample_size: int = config.DEFAULT_SUBSAMPLE_SIZE) -> str:
...
def save_trained_model_weights(model: nn.Module,
    ...
    file_path = get_trained_model_file_path(test_split_size, seed,
                                            subsample_size)
