...
def main(args):
    ...
    # NOTE: seed must be forwarded here -- omitting it meant this always loaded
    # (or silently created) the DEFAULT-seed subsample regardless of --seed,
    # while the split itself was saved under this script's --seed folder: a
    # seed/subsample mismatch whenever a non-default seed was requested.
